#!/usr/bin/env python3
"""
Script pour supprimer les balises <data> dans Odoo 18.0
- Supprime toutes les balises <data> et </data>
- Structure correcte: <odoo><record>...</record></odoo>
"""
import os
import re
...
def remove_data_tags(file_path):
    """Supprimer les balises <data> d'un fichier XML pour Odoo 18.0"""
    try:
